...
#### 1. В роли простого JSON-кодировщика записей в логах
Простейший пример использования библиотеки продемонстрирован в нижеприведенном методе `Demo.example1`:
```java
...
#### 2. Внедрение контекстных данных
